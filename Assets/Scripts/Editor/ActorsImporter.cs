...
namespace Ryneus
{
    public class ActorsImporter : AssetPostprocessor
    {
        ...
        private static void CreateActorInfo(string asset)
        {
            ...
            try
            {
                ...
                using (var Mainstream = File.Open(asset, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
                {
                    ...
                    for (int i = 1; i <= BaseSheet.LastRowNum; i++)
                    {
                        ...
                        ActorData.InitStatus.SetParameter(InitHp, InitMp, InitAtk, InitDef, InitSpd, InitMov, InitCost, 0, 0, 0);
                        ...
                        ActorData.NeedStatus.SetParameter(NeedHp, NeedMp, NeedAtk, NeedDef, NeedSpd, NeedMov, NeedCost, 0, 0, 0);
