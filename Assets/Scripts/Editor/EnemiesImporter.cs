...
namespace Ryneus
{
    public class EnemiesImporter : AssetPostprocessor
    {
        ...
        private static void CreateEnemyData(string asset)
        {
            // 拡張子なしのファイル名を取得
                ...
                using (var Mainstream = File.Open(asset, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
                {
                    ...
                    for (int i = 1; i <= BaseSheet.LastRowNum; i++)
                    {
                        ...
                        var EnemyData = new EnemyData
                        {
                            ...
                            ImageScale = AssetPostImporter.ImportFloat(BaseRow, "ImageScale"),
                        };
                        ...
                        EnemyData.BaseStatus.SetParameter(Hp, Mp, Atk, Def, Spd, Mov, 0, 0, 0, 0);
