...
namespace Ryneus
{
    public class BattleGridLayer : MonoBehaviour
    {
        ...
        public void SetGridMembers(List<BattlerInfo> battlerInfos)
        {
            ...
            SetEnemyInfo(battlerInfos.FindAll(a => !a.IsActor && !a.isAlcana));
        }
        ...
        public void UpdatePosition()
        {
            ...
            foreach (var data in _battlers)
            {
                ...
                rect.localPosition = new Vector3(data.Key.Ap.Value, rect.localPosition.y, 0);
        ...
        public void RefreshStatus()
        {
            foreach (var data in _battlers)
            {
                ...
                UIComponent.SetActive(data.Value.gameObject, data.Key.IsAlive());
            }
        }
