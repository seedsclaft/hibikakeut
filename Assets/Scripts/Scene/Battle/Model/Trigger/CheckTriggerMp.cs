        ...
        public bool CheckTrigger(SkillData.TriggerData triggerData, BattlerInfo battlerInfo, CheckTriggerInfo checkTriggerInfo)
        {
            ...
            switch (triggerData.TriggerType)
            {
                ...
                case TriggerType.FriendMpUnder:
                    return triggerData.Param1 == 100
                    ? checkTriggerInfo.Friends.Find(a => CheckMpRateUnder(a, triggerData.Param1)) != null
                    : checkTriggerInfo.Friends.Find(a => CheckMpRateUnderMore(a, triggerData.Param1)) != null;
                ...
                case TriggerType.OpponentMpUnder:
                    return triggerData.Param1 == 100
                    ? checkTriggerInfo.Opponents.Find(a => CheckMpRateUnder(a, triggerData.Param1)) != null
                    : checkTriggerInfo.Opponents.Find(a => CheckMpRateUnderMore(a, triggerData.Param1)) != null;
